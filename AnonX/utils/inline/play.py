...
#bar of wynk---------------------------------------
    if 0 < anon <= 1:
        ...
        bar = "𐏓꯭ⱺ𝗋𝗂𝗍𝖾 ρᥣα𝗒ᥣ𝗂𝗌𝗍"
    elif 8 <= anon < 9:
        bar = "𝐋α𝗀 𝐅𝗋𝖾𝖾"
    elif 9 <= anon < 10:
        bar = "𐏓꯭꯭ ⃪ɪ⃪𝐁𝐀𝐃 𝐁ⱺ𝗒•❥𓆪𓆪 𝐒𝗍υᑯ𝗂ⱺ"
    elif 10 <= anon < 11:
        bar = "𐏓꯭꯭ ⃪ɪ⃪𝐁𝐀𝐃 𝐁ⱺ𝗒•❥⏤‌⃝🫧𓆪 𝐀ρρ"
    elif 11 <= anon < 12:
        bar = "𝐄𐓣𝗃ⱺ𝗒 𝐉𝗂ⱺ 𝐒αα𝗏𐓣 𝐀ρρ 𝐎𐓣 𝐓𝖾ᥣ𝖾𝗀𝗋αꭑ"
    elif 12 <= anon < 13:
        bar = "𝐄𐓣𝗃ⱺ𝗒 𐏓꯭꯭ ⃪ɪ⃪𝐁𝐀𝐃 𝐁ⱺ𝗒•❥⏤‌⃝🫧𓆪 𝐌υ𝗌𝗂𝖼"
    elif 13 <= anon < 14:
        bar = "𝐉𝗂ⱺ 𝐒αα𝗏𐓣 𝑴𝒖𝒔𝒊𝒄"
    elif 14 <= anon < 15:
        bar = "𝐁𝖾𝗌𝗍 𝐅𝖾α𝗍υ𝗋𝖾𝗌"
        ...
        bar = "𐏓꯭꯭ ⃪ɪ⃪𝐁𝐀𝐃 𝐁ⱺ𝗒•❥⏤‌⃝🫧𓆪 𝐅α𝗏ⱺ𝗋𝗂𝗍𝖾 ρᥣα𝗒ᥣ𝗂𝗌𝗍"
    elif 21 <= anon < 22:
        bar = "𝐋α𝗀 𝐅𝗋𝖾𝖾 𝐉𝗂ⱺ 𝐒αα𝗏𐓣"
    elif 22 <= anon < 23:
        bar = "𝐉𝗂ⱺ 𝐒αα𝗏𐓣 𝐒𝗍υᑯ𝗂ⱺ"
    elif 23 <= anon < 24:
        bar = "𝐄𐓣𝗃ⱺ𝗒 𐏓꯭꯭ɪ 𝐀ρρ 𝐎𐓣 𝐓𝖾ᥣ𝖾𝗀𝗋αꭑ"
    elif 24 <= anon < 25:
        bar = "𝐁𝖾𝗌𝗍 𝐅𝖾α𝗍υ𝗋𝖾𝗌"
    elif 25 <= anon < 26:
        bar = "𝐌𝗂ᥣᥣ𝗂ⱺ𐓣 𝐒ⱺ𐓣𝗀𝗌"
...
# Wynk bar-----------------------------------------------------------
    if 0 < anon <= 2:
        ...
        bar = "𝐋α𝗀 𝐅𝗋𝖾𝖾 𐏓꯭꯭ ⃪ɪ⃪𝐁𝐀𝐃 𝐁ⱺ𝗒•❥⏤‌⃝🫧𓆪 "
    elif 9 <= anon < 10:
        bar = "𝐉𝗂ⱺ 𝐒αα𝗏𐓣 𝐒𝗍υᑯ𝗂ⱺ"
    elif 10 <= anon < 11:
        bar = "𝐉𝗂ⱺ 𝐒αα𝗏𐓣 𝐀ρρ"
    elif 11 <= anon < 12:
        bar = "𝐄𐓣𝗃ⱺ𝗒 𐏓꯭꯭𝐀ρρ 𝐎𐓣 𝐓𝖾ᥣ𝖾𝗀𝗋αꭑ"
    elif 12 <= anon < 13:
        bar = "𝐄𐓣𝗃ⱺ𝗒 𝐉𝗂ⱺ 𝐒αα𝗏𐓣 𝐌υ𝗌𝗂𝖼"
    elif 13 <= anon < 14:
        bar = "𝐉𝗂ⱺ 𝐒αα𝗏𐓣 𝑴𝒖𝒔𝒊𝒄"
        ...
        bar = "𐏓꯭꯭ ⃪ɪ⃪𝐁𝐀𝐃 𝐁ⱺ𝗒•❥⏤‌⃝🫧𓆪α𝗏ⱺ𝗋𝗂𝗍𝖾 ρᥣα𝗒ᥣ𝗂𝗌𝗍"
    elif 33 <= anon < 34:
        bar = "𝐉𝗂ⱺ 𝐒αα𝗏𐓣 𝐀ρρ"
    elif 34 <= anon < 35:
        bar = "𝐉𝗂ⱺ 𝐒αα𝗏𐓣 𝐒𝗍υᑯ𝗂ⱺ"
...
def stream_markup(_, videoid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="𐏓꯭꯭ ⃪ɪ⃪𝐁𝐀𝐃 𝐁ⱺ𝗒•❥⏤‌⃝🫧𓆪", url=f"https://wynk.in/music")
        ],
        [
            InlineKeyboardButton(
                text="𝑪𝒍𝒐𝒔𝒆", callback_data=f"close"
